...
from ahawam.models.wan22.helpers.loader import load_wan22_ti2v_5b_components
...
def main() -> None:
    ...
    parser.add_argument("--model-config", required=True, help="Path to model yaml, e.g. configs/model/fastwam.yaml (baseline) or configs/model/ahawam.yaml")
